#flowingdata
squarePie <- function(values, col=terrain.colors(length(values)), col.grid="#e0e0e0", col.border="black") {
  ...
  # Plot
  plot(0, 0, type="n", xlab="", ylab="", xlim=c(0,11), ylim=c(0,10.5), asp=1, bty="n", axes=FALSE)
